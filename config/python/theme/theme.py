...
if __name__ == '__main__':
    if len(sys.argv) < 2:
        ...
        print(f'Commands: parse, color_named, color_hash, color_zerox, color_css_rgba, color_rgb_int, color_256, color_ansi, color_ansi_fg, color_ansi_bg, color_ansi_reset, font, cursor', file=sys.stderr)
        sys.exit(1)
